...
class SumoIntersection:
    ...
    def chooseMode(self, junctions):
        ...
        averageQueueLength = traci.edge.getLastStepHaltingNumber('R44') \
            + traci.edge.getLastStepHaltingNumber('R38') \
            + traci.edge.getLastStepHaltingNumber('R42')
        averageQueueLength = averageQueueLength / 3

        # Define vehicleId's Of Emergency Vehicles

        emergencyVIds = []
        vehicles_road1 = traci.edge.getLastStepVehicleIDs('R44')
        vehicles_road2 = traci.edge.getLastStepVehicleIDs('R38')
        vehicles_road3 = traci.edge.getLastStepVehicleIDs('R42')
    ...
    def getState(self):
        ...
        junctionPosition = traci.junction.getPosition('N9')[0]
        vehicles_road1 = traci.edge.getLastStepVehicleIDs('R44')
        vehicles_road2 = traci.edge.getLastStepVehicleIDs('R38')
        vehicles_road3 = traci.edge.getLastStepVehicleIDs('R42')
        ...
        phase = traci.trafficlight.getPhaseDuration('N9')
...
if __name__ == '__main__':
    ...
    for e in range(episodes):
        ...
        traci.trafficlight.setPhase('N9', 0)
        traci.trafficlight.setPhaseDuration('N9', 200)
        cpd1 = traci.trafficlight.getPhaseDuration('N9')
        ...
        while traci.simulation.getMinExpectedNumber() > 0 and stepz \
            ...
            if action == 0 or action == 1 or action == 2:
                 ...
                 for i in range(5):
                      stepz += 1
                      traci.trafficlight.setPhase("N9", turn)
                 ...
                 if cpd >= 20 and cpd <= 80:
                    traci.trafficlight.setPhaseDuration('N9', cpd1)
                 else:
                    traci.trafficlight.setPhaseDuration('N9', 20)
